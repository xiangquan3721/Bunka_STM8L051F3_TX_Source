...
{ 
    ...
    //PORT_SetP1OpenDrain(BIT3);                // 设置 P11/P12/P13为开漏输出
    //P13 = 1;                                // P11/P12/P13设为输入模式
    ...
    PORT_SetP2OpenDrain(BIT3|BIT4|BIT6);           //未用IO口全部设为输入
    P23=0;P24=0;P26=0;
...
{
    PORT_SetP1OpenDrain(BIT5|BIT6|BIT7);
    PORT_SetP2OpenDrain(BIT2);
    P16 = 0;                                           
    P22 = 0;P15 = 0;P17 = 0;
