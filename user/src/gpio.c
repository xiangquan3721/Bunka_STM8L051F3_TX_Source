...
{ 
    ...
    /* SPI */
    PORT_SetP1PushPull(BIT4|BIT7);					// 设置P15(MOSI),P17(SPICLK)为准双向口
...
//	PORT_EnP14P15P16P17PullHigh();						// 使能 P14,P15,P16,P17 上拉
    ...
    PORT_SetP2OpenDrain(BIT4|BIT5);
    P24 = 1; P25 = 1;                                  // 设置P24/P25为输入
    ...
    PORT_SetP3PushPull(BIT4|BIT5);                      // 设置P35/P35 为推挽输出
