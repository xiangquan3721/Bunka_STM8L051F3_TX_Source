...
void Init_Clock(void)
{
    ...
    CLK_SetCKCON0(IHRCO_12MHz|CPUCLK_SYSCLK_DIV_1|SYSCLK_MCKDO_DIV_2);
    DelayXus(100);
#endif
	
#if (MCU_SYSCLK == 16000000)
    CLK_SetCKCON0(IHRCO_12MHz|ENABLE_CKM|CKM_OSCIN_DIV_2|CPUCLK_SYSCLK_DIV_1|SYSCLK_MCKDO_DIV_4);
    DelayXus(100);
