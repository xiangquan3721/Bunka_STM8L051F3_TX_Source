...
#define	PIN_KEY_OPEN		1//PA_IDR_IDR2   	// 输入  OPEN键
#define	PIN_KEY_STOP		PA_IDR_IDR2 //PA_IDR_IDR3     // 输入  STOP键
...
#define PIN_LED                 PD_ODR_ODR4     // Output   LED灯
#define PIN_TX_LED              PD_ODR_ODR4     // Output   LED灯
...
#define PIN_test_mode           PA_IDR_IDR3     // 输入     test脚
...
#define	PIN_KEY_STOP_direc	PC_DDR_DDR0     // 输入  STOP键
...
#define PIN_LED_direc           PD_DDR_DDR4     // Output   LED灯
...
#define PIN_test_mode_direc     PA_DDR_DDR3     // 输入     test脚
...
#define	PIN_KEY_STOP_CR1	PC_CR1_C10     // 输入  STOP键
...
#define PIN_LED_CR1             PD_CR1_C14     // Output   LED灯
...
#define PIN_test_mode_CR1       PA_CR1_C13     // 输入     test脚
