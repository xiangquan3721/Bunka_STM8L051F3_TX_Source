...
//	 if(m_RegMode==1)SetTxData(28,ID_data_add,0xFF);    //"1"��׷��
//	 else SetTxData(28,ID_data_add,0);    //"2"��Ĩ��
//       }
//       txphase=0;
//       txphase_Repeat=0;
//       ID_INT_CODE=0;
...
void SendTxData(void)
{
  UINT8 i;
	 ...
	 if(Control_code[Control_code_out][4]==0xff) SetTxData(27,ID_data_add,0xFF);    //"1"��׷��
	 else if(Control_code[Control_code_out][4]==0x0) SetTxData(27,ID_data_add,0);    //"2"��Ĩ��
