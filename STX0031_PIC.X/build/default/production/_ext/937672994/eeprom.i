...
# 2 "<built-in>" 2
# 1 "../Projects/src/eeprom.c" 2
# 10 "../Projects/src/eeprom.c"
...
# 11 "../Projects/src/eeprom.c" 2

# 1 "../Projects/inc\\Pin_define.h" 1
# 12 "../Projects/src/eeprom.c" 2
...
# 15 "../Projects/src/eeprom.c" 2
# 110 "../Projects/src/eeprom.c"
void InitialFlashReg( void ){
...
unsigned char ReadByteEEPROM( unsigned long Addr ){
 return(*(( __far unsigned char* ) Addr ));
}

void WriteByteToFLASH(unsigned long Addr, unsigned char Dat){
 *(( __far unsigned char * ) Addr ) = Dat;
}

void EraseByteFLASH( unsigned int Addr){
 *(( __near unsigned char * ) Addr) = 0x00;
}
...
void eeprom_save(void){
 ...
 for (i=0;i<16;i++)
  WriteByteToFLASH( 0x1000 +i, eeprom_sys_buff);
 LockFlash( ((unsigned char)0x01 ) );
}
void eeprom_sys_load(void){
# 173 "../Projects/src/eeprom.c"
   unsigned char i,j;
# 186 "../Projects/src/eeprom.c"
  ID_data.IDL=0x01;
...
void KeyOpt_EEPROM_write(void)
{
# 231 "../Projects/src/eeprom.c"
     UnlockFlash( ((unsigned char)0x01 ) );
 WriteByteToFLASH( 0x1000 +0x70, rom_KeyOpt);
     LockFlash( ((unsigned char)0x01 ) );
