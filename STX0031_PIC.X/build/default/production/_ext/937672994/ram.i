...
# 10 "../Projects/src/ram.c" 2

# 1 "../Projects/inc\\Pin_define.h" 1
# 11 "../Projects/src/ram.c" 2
...
unsigned char m_RFNormalBuf[40];
uni_rom_id ID_data;
uni_rom_id ID_data_add;
unsigned char Control_code;
unsigned int txphase;
unsigned char txphase_Repeat;
unsigned char ID_INT_CODE;
unsigned int txphase_end;

unsigned int TIME_BEEP_on;
unsigned char TIME_BEEP_off;
unsigned int BASE_TIME_BEEP_on;
unsigned char BASE_TIME_BEEP_off;
unsigned char TIME_BEEP_freq;

unsigned char TB_976us;
unsigned char TB_100ms;
unsigned char TB_5s;

unsigned char SIO_cnt;
...
unsigned char m_KeyNew;
unsigned char m_KindOfKey;
unsigned char m_KeyOld;
unsigned int m_ChatterCount;
unsigned int m_TimerKey;
unsigned char m_KeyNo;
unsigned char m_KeyOptSetMode;
unsigned char m_KeyOpenCount;
unsigned char m_KeyCloseCount;
unsigned int m_KeyDupli1stTimer;
unsigned char m_KeyOptSetMode;
unsigned int m_KeyDupliSetTimeout;
unsigned char rom_KeyOpt;
unsigned int time_led;
unsigned int m_TimerKeyMonitor;
unsigned char m_KeyCount;
unsigned char m_RegMode;
unsigned char m_RegID[9];
unsigned char m_RegDigit;
unsigned int m_TimerRegMode;

unsigned char AD_DATA_BUFF[2];
unsigned long RAM_BAT_SUM=0;
unsigned int RAM_BAT_AVG=0;
unsigned char RAM_BAT_CNT=0;
unsigned char BAT_out=0;
unsigned long BAT_Voltage_value=0;

unsigned int TIME_Once_twice_switch=0;
unsigned int TIME_10s=0;
unsigned int key_Value=0;

unsigned char TIME_2s_RestTX=0;
