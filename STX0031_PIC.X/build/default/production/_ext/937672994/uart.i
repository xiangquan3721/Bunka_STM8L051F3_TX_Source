...
# 10 "../Projects/src/uart.c" 2

# 1 "../Projects/inc\\Pin_define.h" 1
# 11 "../Projects/src/uart.c" 2
 ...
 if (BIT_SIO){
  ...
  case 'W':
   ...
   if (SIO_DATA[2]=='G')
   {
    ...
    UnlockFlash( ((unsigned char)0x01 ) );
    WriteByteToFLASH(0x1000 +0x10,d1);
    WriteByteToFLASH(0x1000 +0x11,d2);
    WriteByteToFLASH(0x1000 +0x12,d3);
    LockFlash( ((unsigned char)0x01 ) );
   ...
   if (SIO_DATA[2]=='H')
   {
    ...
    j=0x20+i*4;
    UnlockFlash( ((unsigned char)0x01 ) );
    WriteByteToFLASH(0x1000 +j,d0);
    WriteByteToFLASH(0x1000 +j+1,d1);
    WriteByteToFLASH(0x1000 +j+2,d2);
    WriteByteToFLASH(0x1000 +j+3,d3);
    LockFlash( ((unsigned char)0x01 ) );
