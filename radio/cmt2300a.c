...
/*оƬ������Դ���룬�ṩоƬ״̬�л������� �жϣ� GPIO�� FIFO ������ ͨ�üĴ������ú�
���ʵȡ� �˲������ڹ̻��ĳ��򣬺� MCU ƽ̨�޹أ��û��ɲ��ö����޸�*/
...
* @param   nChann: the frequency channel    (FREQ = ����Ƶ�� + 2.5KHz * nOffset *  nChann)
* *********************************************************/
...
* @param   nOffset: the frequency step  (FREQ = ����Ƶ�� + 2.5KHz * nOffset *  nChann)
* *********************************************************/
...
//    CMT2300A_DelayMs(1);
    ...
    tmp |= CMT2300A_MASK_CFG_RETAIN;         /* Enable CFG_RETAIN *//*��CUS_MODE_STA��0x61���Ĵ����ĵ� 4 ������ CFG_RETAIN ���ó� 1��
    ������ػ��� 0x00 �C 0x5F������������ֵ���ᱻ����λ������*/
    tmp &= ~CMT2300A_MASK_RSTN_IN_EN;        /* Disable RSTN_IN */
    Cmt_Spi_Write(CMT2300A_CUS_MODE_STA, tmp);

    CMT2300A_EnableLfosc(FALSE);             /* Diable LFOSC *///0����Ҫʹ��SLEEP TIMER
