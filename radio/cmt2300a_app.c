...
xdata u32 SPI_Receive_DataForC[7];
xdata u32 DATA_Packet_ID = 0;
xdata u8 DATA_Packet_Contro_buf = 0;

xdata u8 g_rxBuffer[RF_PACKET_SIZE] = {0};   /* RF Rx buffer */
xdata u8 g_txBuffer[RF_PACKET_SIZE] = {0};
